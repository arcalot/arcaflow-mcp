...
See the **[Getting Started Guide](docs/arcaflow-mcp/getting-started.md)** for complete installation and setup instructions, including:

- **Containers** (fastest) - Pull pre-built images and run with Podman or Docker
- **Pre-compiled binaries** - Download from GitHub Releases (after v0.1.0)
- **Build from source** - For development and customization

For development environment setup, see **[Development Setup](docs/development/setup.md)**.
